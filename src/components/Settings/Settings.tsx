                        ...
                        <nav className="space-y-2">
                            {sidebarItems.map((item) => (
                                <button
                                    ...
                                    className={`w-full flex items-center justify-between px-4 py-3 text-left rounded-lg transition-colors ${activeSection === item.id ? "bg-[#FE0659] text-white" : "text-gray-700 hover:bg-gray-100"
                                        }`}
                                >
